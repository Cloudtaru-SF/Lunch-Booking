...
export default class LMn_lwcDatatableUtility extends LightningElement {
    ...
    @api hidecheckbox = false; //to Hide Checkbox Column
    ...
    connectedCallback() {
        ...
        if(this.filtredNum && this.filtredNum>0){
    ...
    @api loadPageData(){
        console.log('--loadPageData---columns------->',this.columns);
        console.log('--loadPageData---records------->',this.records);
        console.log('--loadPageData---pageSizeOptions------->',this.pageSizeOptions);
        console.log('--loadPageData---totalRecords------->',this.totalRecords);
        if(this.pageSizeOptions && this.pageSizeOptions.length > 0){
            this.pageSize = this.pageSizeOptions[0];
            this.showPagination = true;
        }else{
    ...
    handleRowAction(event){
        ...
        this.dispatchEvent(new CustomEvent(event.detail.action.name, {detail: recId}));
    }
